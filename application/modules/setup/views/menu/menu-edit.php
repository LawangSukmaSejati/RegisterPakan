			...
			<div class="box-body big">
				<form class="form-horizontal row-border"  method="post" id="form">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input value="<?php echo $parsing->label;?>" class="form-control" type="text" name="label" id="label" placeholder="Label">
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">Icon:</label> 
						<div class="col-md-4">
							<input value="<?php echo $parsing->icon;?>" class="form-control" type="text" name="icon" id="icon" placeholder="Icon">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-4">							
							<select class="col-md-12 full-width-fix" name="link" id="link">								
								...
								<?php printTree($link,'','',$parsing->resource_id); ?>
							</select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-4">
							...
							<option value="0">Unidentify</option>
							<?php printTree($menu_parent,'','',$parsing->id); ?>
							</select>
						</div>
					</div>
					<div class="form-group">
...
function edit(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: url+'setup/menu/execute/update',
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
