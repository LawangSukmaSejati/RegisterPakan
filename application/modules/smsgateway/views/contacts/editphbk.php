...
<div class="row">
	<div class="col-md-6">
		...
		<div class="box border orange">
			<div class="box-title">
				<h4><i class="fa fa-reorder"></i>Add Phone Book</h4>
			...
			<div class="box-body big">
				<form class="form-horizontal row-border"  method="post" id="form">
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input  class="form-control" type="text" name="number" id="number" placeholder="Number" value="<?php echo $parsing->number;?>">
						</div>
					</div>
				<!--	<div class="form-group">
...
function save(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: url+'smsgateway/contact/updatephbk',
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
