			...
			<div class="box-body big">
				<form class="form-horizontal row-border"  method="post" id="form">
					<div class="form-group">
						...
						<div class="col-md-4">
							<input  class="form-control" type="text" name="code" id="code" placeholder="Code" value="<?php echo $rows->code;?>">
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">name:</label> 
						<div class="col-md-4">
							<input  class="form-control" type="text" name="name" id="name" placeholder="name" value="<?php echo $rows->name;?>">
						</div>
					</div>
...
function sends(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: url+'execute/update/crud/id/<?php echo $rows->id;?>',
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
