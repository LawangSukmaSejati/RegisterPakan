...
<div class="row">
    <div class="col-md-12">
        <!-- BOX -->
        <a  class="btn btn-info btn-md pull-right" href="<?php echo site_url('registrasi/permohonan/form_a_form');?>">Tambah</a>
                <br/>
                <br/>
                <br/>
        <div class="box border blue">
            <div class="box-title">
                <h4><i class="fa fa-table"></i>Form A</h4>              
            </div>
            <div class="box-body">
                <form class="form-horizontal "  >
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-2 control-label">Status Berkas:</label> 
                        <div class="col-md-4">
                            <input  class="form-control" type="text" name="tanggal_pemohon" value="<?php //echo $identity->status;?>"id="nomor_pemohon" disabled>                           
                        </div>
                    </div>
                </form>
                    ...
                    <tbody>
                        ...
                        <tr id="rows-<?php echo $value->id;?>">
                            ...
                            <td>
                                ...
                                <a  title="Edit" class="btn btn-success btn-xs" href="<?php echo site_url('registrasi/permohonan/form_a_form/'.$value->id);?>">Edit</a>
