...
<div class="row">
	<div class="col-md-10">
		...
		<div class="box border red">
			<div class="box-title">
				<h4><i class="fa fa-reorder"></i>Replay Sms</h4>
			...
			<div class="box-body big">
				<form class="form-horizontal row-border"  method="post" id="form">
					<div class="form-group">
						...
						<div class="col-md-4">
							<span class="label label-success"><?php echo $parsing->RecipientID;?></span>
						</div>
					</div>					
					<div class="form-group">
						<label class="col-md-2 control-label">Destination Number:</label> 
						<div class="col-md-4">
							<span class="label label-info"><?php echo $parsing->SenderNumber;?></span>
						</div>
					</div>					
					<div class="form-group">
					...
					<div class="form-actions">
						<div class="row">						
							<div class="col-md-12">		
								...
								<input type="hidden" name="number" id="number" value="<?php echo $parsing->SenderNumber;?>">
								<input type="hidden" name="device" id="device" value="<?php echo $parsing->RecipientID;?>">
...
function sends(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: url+'smsgateway/messages/balas_send',
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
