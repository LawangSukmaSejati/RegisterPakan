...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box border green">
            <div class="box-title">
                <h4><i class="fa fa-reorder"></i>Form B. Jenis Bahan Baku FL/01B/PB/002</h4>
            ...
            <div class="box-body big">
                <form class="form-horizontal row-border"  method="post" id="form">                    
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Jenis Bahan Baku:</label> 
                        <div class="col-md-10">
                            <input  class="form-control" type="text" name="jenis_bahan_baku" id="jenis_bahan_baku" placeholder="jenis_bahan_baku">
                        </div>
                    </div>
                    <div class="form-group">
...
function sends(){
    $('#form').validate({
        ...
        submitHandler: function(form){
            $.ajax({
                url: url+'execute/save/p_form_b_bahan_baku',
                type: "POST",
                dataType:"json",
                data: $("#form").serialize(),
                beforeSend: function(){
                ...
                success:function(data){
                    new PNotify({
                        title: 'Formulir B jenis_bahan_baku',
