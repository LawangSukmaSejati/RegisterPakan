...
<div class="row">
	<div class="col-md-12">
		...
		<div class="box border green">
			<div class="box-title">
				<h4><i class="fa fa-table"></i>Registrasi</h4> 
				<div class="tools hidden-xs">
					<a  class="btn btn-warning btn-xs" href="<?php echo site_url('file/registrasi/add');?>">Add New</a>
				<br/>
				</div>
			</div>
			<div class="box-body">
...
$(document).ready(function() {    
    $('#data').dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": url+"file/registrasi/load",
        "sServerMethod": "POST",        
        "aaSorting": [[1, "asc"]],
        "iDisplayLength": 10,           
        "aoColumns" : [                                    
            ...
            {"mData": "show",
            	"mRender" : function ( data, type, full ) {             
            		var link = '<a  title="Edit"class="btn btn-warning btn-xs" href='+url+'file/registrasi/edit/'+full.id+'><i class="fa fa-pencil"></i></a> || '+
    ...
    $('#data').delegate('.checkbox','change',function() {
        ...
        if(this.checked){            
            $.ajax({
                url: url+'file/registrasi/execute/active',
                type: 'post',
                data: 'active=0&id='+i,
...
function del(btn)
{
	...
	else
	{
		...
		$.ajax({
			url: url+'file/registrasi/execute/delete/'+id,
			type: "POST",
			data:{data_id:id},
			crossDomain:true,
			beforeSend: function(){
