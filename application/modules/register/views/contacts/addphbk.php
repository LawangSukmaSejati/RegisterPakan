			...
			<div class="box-body big">
				...
				<!--	<div class="form-group">
					...
					<div class="form-actions">
						<div class="row">						
							<div class="col-md-12">								
								<input id="send" type="submit" class="btn btn-primary btn-lg pull-right" onclick="save(this);" value="Save"/>													
								<div id="loading"></div>
							</div>							
						</div>
					</div>										   
...
function save(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: url+'smsgateway/contact/tambahphbk',
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
